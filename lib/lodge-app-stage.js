...
const { getIpsAndSubnets } = require("./utils/getIpsAndSubnets");
...
class LodgeAppStage extends cdk.Stage {
  constructor(scope, id, props) {
    ...
    if (importedVPCId) {
      ...
      lodgeVPC.vpcStack.ipsAndSubnets = getIpsAndSubnets(lodgeVPC.vpcStack.vpc);
    ...
    const lodgeElasticsearch = new LodgeElasticsearchStack(
      ...
      "LodgeElasticsearchStack",
      {
        ...
        ipsAndSubnets: lodgeVPC.vpcStack.ipsAndSubnets,
      }
    );
