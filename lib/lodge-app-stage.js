...
class LodgeAppStage extends cdk.Stage {
  constructor(scope, id, props) {
    ...
    if (data.lodgeVpc.id) {
      ...
      // let filteredPrivateSubnets = lodgeVPC.vpcStack.vpc.privateSubnets;
      // let filteredPublicSubnets = lodgeVPC.vpcStack.vpc.publicSubnets;
...
module.exports = { LodgeAppStage, LodgeExistingVPC };
