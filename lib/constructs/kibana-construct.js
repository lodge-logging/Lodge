...
class Kibana extends cdk.Construct {
  constructor(scope, id, props) {
    ...
    this.instance = new ec2.Instance(this, "Kibana", {
      ...
      vpcSubnets: {
        subnets: [
          ec2.Subnet.fromSubnetAttributes(this, `KibanaSubnetFromAttributes1`, {
    ...
    this.instance.userData.addCommands(
      ...
      "ip=${var//./-}",
      `sudo sed -i "s|#server.host:.*|server.host: \\"ec2-$ip.${region}.compute.amazonaws.com\\"|" /etc/kibana/kibana.yml`,
