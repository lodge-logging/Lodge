...
class VPC extends cdk.Construct {
  constructor(scope, id, props) {
    ...
    if (props.existingVPC) {
      ...
      this.ipsAndSubnets = Object.keys(subnets).map((subnet, i) => {
        return {
      ...
      this.vpc = new ec2.Vpc(this, "VPC", {
        cidr: this.node.tryGetContext("APP_CIDR"),
        // cidr: this.node.tryGetContext("APP_CIDR") || params.VPCCidrBlock,
        // gatewayEndpoints: '',
      ...
      //   { cidr: this.vpc.publicSubnets[1].ipv4CidrBlock },
      //   { cidr: this.vpc.publicSubnets[2].ipv4CidrBlock },
      // ]);
    }

    this.userCidr =
      this.node.tryGetContext("USER_CIDR") || this.vpc.vpcCidrBlock;
    //this.userCidr = this.node.tryGetContext("USER_CIDR") || "0.0.0.0/0";
    ...
    // webtoolSG.connections.allowFromAnyIpv4(ec2.Port.tcpRange(8001, 8080));
