...
class Elasticsearch extends cdk.Construct {
  constructor(scope, id, props) {
    ...
    // iam.Role();
    const subnets = props.vpc.privateSubnets;

    this.master1 = new ec2.Instance(this, 'ES-Master-1', {
      vpc: props.vpc,
    ...
    this.master2 = new ec2.Instance(this, 'ES-Master-2', {
      vpc: props.vpc,
      machineImage: new ec2.AmazonLinuxImage(),
      instanceType: new ec2.InstanceType(params.MasterInstanceType),
      securityGroup: props.securityGroup,
    ...
    this.voteOnly = new ec2.Instance(this, 'ES-Vote-Only', {
      vpc: props.vpc,
      machineImage: new ec2.AmazonLinuxImage(),
    ...
    this.dataHotASG = new autoscaling.AutoScalingGroup(this, 'Data-Hot-ASG', {
      vpc: props.vpc,
      machineImage: new ec2.AmazonLinuxImage(),
    ...
    this.dataWarmASG = new autoscaling.AutoScalingGroup(this, 'Data-Warm-ASG', {
      vpc: props.vpc,
      machineImage: new ec2.AmazonLinuxImage(),
